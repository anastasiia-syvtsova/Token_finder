...
set CLASSPATH=%APP_HOME%\lib\Assignment1.jar;%APP_HOME%\lib\annotations-20.1.0.jar


@rem Execute Assignment1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ASSIGNMENT1_OPTS%  -classpath "%CLASSPATH%" de.uniba.wiai.dsg.ajp.assignment1.Main %*
